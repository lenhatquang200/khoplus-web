$(document).ready(async function () {
    ...
    if (response.success) {
        ...
        $('#modalFormSubmit').submit(async e => {
            ...
            if (type) {
                const response = await tools.ajaxPost("/product-units", {
                    name: name
                })
                if (response.success) {
                ...
                const response = await tools.ajaxPut("/product-units/" + id, {
                    name: name
                })
                if (response.success) {
        ...
        async function deleteRow(data) {
            const response = await tools.ajaxDelete("/product-units/" + data.id)
            if (response.success) {
